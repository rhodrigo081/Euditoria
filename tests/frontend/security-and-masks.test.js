...
// 2. Validação Módulo 11 (CPF e CNPJ)
...
assert.strictEqual(validateCnpj('12.345.678/0001-95'), true, 'CNPJ válido com dígitos calculados');
assert.strictEqual(validateCnpj('11.111.111/1111-11'), false, 'CNPJ repetido deve falhar');
assert.strictEqual(validateCnpj('12.345.678/0001-00'), false, 'CNPJ com dígito verificador inválido deve falhar');
